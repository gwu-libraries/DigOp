...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ui', ['ProcessingSession'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table('ui_item')

        # Deleting model 'ProcessingSession'
        db.delete_table('ui_processingsession')
    ...
    models = {
        ...
        'ui.item': {
            ...
            'totalPages': ('django.db.models.fields.IntegerField', [], {})
        },
        'ui.processingsession': {
            'Meta': {'object_name': 'ProcessingSession'},
            'comments': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'endTime': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ui.Item']"}),
