...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('ui', ['Project'])
    ...
    models = {
        ...
        'ui.item': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ui.Project']"}),
